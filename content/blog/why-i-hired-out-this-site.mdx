...
_UPDATE: Since writing this article I've updated the site to use Next.js. Much of the work builds upon Cole's initial implementation, but the code is no longer what it was at launch._

_That said, Cole was still a huge part of getting this site up and running. The article below tells that story._
...
At the same time, I had started mentoring a few people over at [codingcoach.io](https://codingcoach.io) which was _awesome_. Among them was Emeruche Cole. He is an awesome engineer; very capable and learns new technologies quickly.
