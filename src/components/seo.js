...
const SEO = ({ description, title }) => {
  ...
  return (
    <Head>
      ...
      <meta
        property="og:image"
        content="https://brentmclark.dev/profile-photo.jpg"
      />
      ...
      <meta
        ...
        content="Brent M. Clark wearing headphones over his ears while sitting in a red chair.  The chair looks like it's from a spaceship.  Brent is looking up and to the left in attempt to look silly."
      />
    </Head>
  )
}
